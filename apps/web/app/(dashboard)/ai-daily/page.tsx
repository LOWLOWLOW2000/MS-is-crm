/**
 * AI日報。左ナビ「AI日報」のメイン。1カラム。
 */
export default function AiDailyPage() {
  return (
    <div className="mx-auto w-full max-w-4xl flex-1 px-4 py-6">
      <h1 className="text-xl font-bold text-gray-900">AI日報</h1>
      <p className="mt-2 text-sm text-gray-600">
        PJを選びAIが日報を生成。投函後はスレッドでディレクターと返信できます。
      </p>
      <section className="mt-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm" aria-label="AI日報メイン">
